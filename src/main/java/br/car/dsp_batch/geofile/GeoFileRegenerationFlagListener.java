...
public class GeoFileRegenerationFlagListener implements JobExecutionListener {
    ...
    public void afterJob(JobExecution jobExecution) {
        ...
        switch (syncKey) {
            ...
            case SyncKeys.AREA_OF_INTEREST -> markAreaOfInterestParents(syncKey, previousWatermark);
            default -> log.debug(
    ...
    private void markAreaOfInterestParents(String syncKey, Instant previousWatermark) {
